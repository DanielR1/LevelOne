...
private void makeAlbum() {
	...
	// this...
	images.put(new Integer(KeyEvent.VK_UP), "cocoa-puffs.jpg"); // theg spoon will be connected to the UP key
	images.put(new Integer(KeyEvent.VK_LEFT), "hp1-steak.jpg"); // the chopstick will be connected to the LEFT key
...
public void keyPressed(KeyEvent e) {
	...
	if(whichKeyPressed == correctUtensilCode){
		JOptionPane.showMessageDialog(null,"Poke" );
	}
